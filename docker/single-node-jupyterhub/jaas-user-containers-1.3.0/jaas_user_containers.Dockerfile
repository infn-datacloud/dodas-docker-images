...
RUN python3 -m pip --no-cache-dir install --upgrade pip && \
    pip install --no-cache-dir jupyter_client==8.2.0 \
...
ADD https://repo.cloud.cnaf.infn.it/repository/sts-wire/sts-wire-linux/2.1.5/sts-wire-linux-2.1.5 /.init/sts-wire
