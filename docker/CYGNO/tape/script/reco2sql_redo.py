...
#    sqlLog = "SELECT * FROM `Runlog`  WHERE `online_reco_status` = 1 AND `pedestal_run` = 0 AND `run_number` < 23801 ORDER BY `run_number` DESC LIMIT 1000;"
    sqlLog = "SELECT * FROM `Runlog`  WHERE `online_reco_status` = 1 AND `run_number` > 23119 AND `pedestal_run` = 0 AND `run_number` < 23615 ORDER BY `run_number` DESC LIMIT 1000;"
