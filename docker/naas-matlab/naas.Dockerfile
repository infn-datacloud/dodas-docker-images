...
FROM harbor.cloud.infn.it/datacloud-templates/jaas_user_containers:CLOUD-2252 AS base_jupyter_image

# Base Jupyter image with LICENSE_SERVER
FROM harbor.cloud.infn.it/datacloud-templates/jaas_user_containers:CLOUD-2252 AS base_jupyter_image_with_lm
ARG LICENSE_SERVER
